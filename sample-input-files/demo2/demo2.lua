-- Dissector for DEMO2 --
local proto = Proto("DEMO2", "DEMO2 Test Protocol")

-- Protocol field definitions --
local fields = proto.fields
fields.f1 = ProtoField.uint8("proto.f0", "Message ID", base_DEC, nil, nil, "Some ID of the message")
...
fields.f4 = ProtoField.bytes("proto.f3", "Destination info", nil, nil, nil, nil)
